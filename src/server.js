...
app.get("/", (req, res) => {
  res.json({
    ...
    endpoints: [
      ...
      "/api/day-20",
      "/api/day-20/tasks",
      "/api/day-20/checklist",
      "/api/day-20/progress",
      "/api/day-21",
      "/api/day-21/tasks",
      "/api/day-21/checklist",
      "/api/day-21/progress",
      "/api/day-22",
      "/api/day-22/tasks",
      "/api/day-22/checklist",
      "/api/day-22/progress",
      "/api/day-23",
      "/api/day-23/tasks",
      "/api/day-23/checklist",
      "/api/day-23/progress",
    ],
  });
});
...
app.get("/api/day-20", (req, res) => {
  res.json(getDay20Summary());
});

app.get("/api/day-20/tasks", (req, res) => {
  const tasks = getDay20Tasks(req.query.topic);
...
app.get("/api/day-20/tasks/:id", (req, res) => {
  const task = getDay20TaskById(req.params.id);
...
app.get("/api/day-20/checklist", (req, res) => {
  const checklist = getDay20Checklist();
...
app.get("/api/day-20/progress", (req, res) => {
  res.json(getDay20Progress());
});

app.get("/api/day-21", (req, res) => {
  res.json(getDay21Summary());
});

app.get("/api/day-21/tasks", (req, res) => {
  const tasks = getDay21Tasks(req.query.topic);
...
app.get("/api/day-21/tasks/:id", (req, res) => {
  const task = getDay21TaskById(req.params.id);
...
app.get("/api/day-21/checklist", (req, res) => {
  const checklist = getDay21Checklist();
...
app.get("/api/day-21/progress", (req, res) => {
  res.json(getDay21Progress());
});

app.get("/api/day-22", (req, res) => {
  res.json(getDay22Summary());
});

app.get("/api/day-22/tasks", (req, res) => {
  const tasks = getDay22Tasks(req.query.topic);
...
app.get("/api/day-22/tasks/:id", (req, res) => {
  const task = getDay22TaskById(req.params.id);
...
app.get("/api/day-22/checklist", (req, res) => {
  const checklist = getDay22Checklist();
...
app.get("/api/day-22/progress", (req, res) => {
  res.json(getDay22Progress());
});

app.get("/api/day-23", (req, res) => {
  res.json(getDay23Summary());
});

app.get("/api/day-23/tasks", (req, res) => {
  const tasks = getDay23Tasks(req.query.topic);
...
app.get("/api/day-23/tasks/:id", (req, res) => {
  const task = getDay23TaskById(req.params.id);
...
app.get("/api/day-23/checklist", (req, res) => {
  const checklist = getDay23Checklist();
...
app.get("/api/day-23/progress", (req, res) => {
  res.json(getDay23Progress());
});
